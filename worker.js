const config = {
  ...
  theme: "theme/pastebin", // 管理面板的主题 // Homepage theme, use the empty value for default theme. To use urlcool theme, please fill with "theme/urlcool" .
  ...
  system_type: "other", // 系统的功能定义 // shorturl, imghost, other types {pastebin, journal}
}
...
let index_html = "https://227575.github.io/Url-Shorten-Worker/" + config.theme + "/index.html"
let result_html = "https://227575.github.io/Url-Shorten-Worker/" + config.theme + "/result.html"
...
const html404 = `<!DOCTYPE html>
  ...
  <body>
    ...
    <p> <a href="https://github.com/227575/Url-Shorten-Worker/" target="_self">Fork me on GitHub</a> </p>
  </body>
  </html>`
...
async function handleRequest(request) {
  ...
  if (!path) { 
    try {
      return Response.redirect("https://abc.cs.do", 302)
    } catch (e) {
